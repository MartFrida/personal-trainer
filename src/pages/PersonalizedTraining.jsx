  ...
  return (
    <ContainerMain className={`${theme.background} ${theme.text} p-8 mt-20 flex justify-center flex-col overflow-auto scroll-smooth w-full`}>
      ...
      <SectionRegular id="running" >
        ...
        <p className="leading-relaxed tracking-wide text-gray-700 my-2">📅 Book a Free Consultation Today!</p>
      ...
      <SectionRegular id="calistenia" >
        ...
        <p className="leading-relaxed tracking-wide text-gray-700">📅 Book Your Free Consultation Now!!</p>
      </SectionRegular>
      ...
      <SectionRegular id="culturismo">
        ...
        <p className="leading-relaxed tracking-wide text-gray-700">📅 Start Your Transformation Today! Book a Free Consultation!</p>
      </SectionRegular>
      ...
      <SectionRegular id="fitnes">
        ...
        <p className="leading-relaxed tracking-wide text-gray-700">📅 Start Your Fitness Journey Today – Book Your Free Consultation!</p>
      </SectionRegular>
